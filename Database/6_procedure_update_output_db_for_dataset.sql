...
BEGIN
	...
	INSERT INTO eucaim_cdm_output.image_series(study_id, study_uid, series_uid, series_number, series_description, series_manufacturer, series_body_side_code, series_acquisition_date, series_modality)
	SELECT ois.Id, ois.study_uid, ImageSeriesUID, ImageSeriesNumber, Description, Manufacturer, BodyPart, cast(AcquisitionDate as date), modality
	...
	SELECT iise.Id, iita.ImageSeriesUID, 'IMG1016306', null, SliceThickness, null
	...
	JOIN eucaim_cdm_ingestion.ImageSeries iise ON iita.ImageSeriesUID = iise.ImageSeriesUID
	WHERE iis.DatasetIdentifier = p_dataset_id;
