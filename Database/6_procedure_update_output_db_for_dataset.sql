...
BEGIN
	...
	INSERT INTO eucaim_cdm_output.image_series(study_id, series_uid, series_number, series_description, series_manufacturer)
	SELECT ois.study_id, ImageSeriesUID, ImageSeriesNumber, Description, Manufacturer
