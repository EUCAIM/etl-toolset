...
CREATE TABLE IF NOT EXISTS eucaim_cdm_ingestion.Tumor (
    ...
    BodySiteEUCAIM VARCHAR(100),
    BodySiteOriginal VARCHAR(100),
    BodySiteLocationQualifierEUCAIM VARCHAR(200),
    BodySiteLocationQualifierOriginal VARCHAR(200),
    BodySiteLateralityQualifierEUCAIM VARCHAR(200),
    BodySiteLateralityQualifierOriginal VARCHAR(200),
