...
TEST_CSV_CLINICAL="sample_data/aaaadcw3slp2bbsux2urluqaae_perproglio_synthetic_sample_2.csv"
...
TEST_CSV_IMAGING="sample_data/aaaadcw3slp2bbsux2urluqaae_PerProGlio_DICOM_metadata_testing_02.csv"
NUMBER_OF_STUDIES=3
