...
Build the images:
```
docker build -t harbor.eucaim-node.i3m.upv.es/library/etl/postgres-etl:15-2 images/postgresql
...
Upload the images:
```
docker push harbor.eucaim-node.i3m.upv.es/library/etl/postgres-etl:15-2
