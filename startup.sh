...
mkdir -m 777 -p ./nifi_data/nifi_content_repository ./nifi_data/nifi_data ./nifi_data/nifi_database_repository ./nifi_data/nifi_flowfile_repository ./nifi_data/nifi_provenance_repository ./input_data/clinical_data ./input_data/image_metadata ./staging_data/curated_as_csv/clinical_data ./staging_data/input_as_csv/clinical_data ./staging_data/input_as_csv/image_metadata ./output_data/clinical_data ./output_data/image_metadata ./registry/database ./registry/flow-storage ./TDC_Output
